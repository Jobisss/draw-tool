        ...
        <For each={props.studies}>
          {(s) => (
            <A
              ...
              class="group overflow-hidden rounded-md border border-line bg-surface transition-shadow hover:shadow-md"
            >
              <div class="grid aspect-square place-items-center bg-surface2">
                <Show
                  when={s.thumb_path}
                  fallback={
                    <span class="text-3xl uppercase text-faint">
                      {s.format}
                    </span>
                  }
                >
              ...
              <div class="p-2">
                ...
                <p class="text-xs uppercase text-faint">{s.format}</p>
              </div>
            </A>
          )}
        </For>
